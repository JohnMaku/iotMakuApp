...
//credenciales para conectarnos a la api de emqx
const auth = {
  auth: {
    username: "admin",
    password: "emqxsecret"
...
//estas dos variables globales pueden ser accedidas desde cualquier archivo.
...
// ****************************************
// Cada vez que arranquemos nuestra api node, esta parte de codigo hara: ir a emqx resource tomar la lista
// de los recursos creados(webhook de los saverRules y el de los alarmRules ) sino estan estos dos, seran
// creados desde nuestra api.
...
async function listResources() {
  try {
    ...
    if (res.status === 200) { //200 es el codigo que emqx determina que todo salio bien
      if (size == 0) {
